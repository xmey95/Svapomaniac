...
function showContent(){
  ...
  var spesa = 0;
  var raccolta = 0;
  var str = '<header class="toolbar toolbar-header"><div class="toolbar-actions"><button class="btn btn-default" onclick="deleteProject()"><span class="icon icon-cancel-circled"></span> Elimina progetto</button><form name="addvoice" id="addvoice" onsubmit="validateFormVoice()" class="form-inline"><div class="row"><div class="form-group col-xs-6"><input id="addvoicename" class="form-control input-group-lg" style="max-width: 200px; margin: 5px;" type="text" name="firstname" title="Enter first name" placeholder="Name"/><input id="addvoicemoney" class="form-control input-group-lg" style="max-width: 100px; margin: 5px;" type="number" name="addvoicemoney" title="Euro" placeholder="Euro"/><button type="submit" class="btn btn-form btn-primary" style="margin: 8px;">OK</button></div></div></header><div><table class="table-striped"><thead><tr><th>Nome</th><th>Euro</th></tr></thead><tbody>';
